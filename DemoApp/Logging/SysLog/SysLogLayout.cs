...
namespace DemoApp.Logging.SysLog
{
    ...
    public class SysLogLayout : LayoutSkeleton
    {
        ...
        public SysLogLayout()
        {
            ...
            this._layout = new PatternLayout("<%syslog-priority>1 %utcdate{yyyy-MM-ddTHH:mm:ss.FFZ} %syslog-hostname %syslog-domainname %appdomain " +
            ...
            this._layout.AddConverter("syslog-domainname", typeof(HostnameConverter));
        ...
        public SysLogLayout(string pattern)
        {
            IgnoresException = false;  //TODO deal with this. sealed?
            ...
            this._layout = new PatternLayout(pattern);
        ...
        public bool OnlyFirstLine { get; set; }
        ...
        public override void Format(TextWriter writer, LoggingEvent logEvent)
        {
            ...
            using (var stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if (OnlyFirstLine)
                {
                    if (message.Contains("\n"))
                    {
                        message = message.Replace("\r", "").Substring(0, message.IndexOf('\n'));
                    }
